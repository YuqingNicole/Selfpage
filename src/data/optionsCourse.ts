...
export const optionsCourse: Unit[] = [
  ...
  {
    id: 'u15',
    title: '第 15 单元 · 链上套利入门',
    subtitle: 'AMM 定价、资金费率与稳定币折价',
    color: '#627eea',
    colorDark: '#4c63bb',
    icon: '⛓️',
    lessons: [
      {
        ...
        diagram: 'amm',
        analogy:
          '两个村子的集市：同一筐苹果东村卖 10 元、西村卖 11 元，挑夫来回倒卖赚差价——直到两边价格被拉平。链上的「挑夫」是机器人，快到以毫秒计，而且每趟都要交过路费（gas）。',
        tips: [
          'AMM（自动做市商）没有订单簿：Uniswap 类 DEX 用恒定乘积公式 x·y=k 定价，价格由池内两种资产的比例决定。',
          '交易本身会推动池内价格：买得越多价格被推得越高，实际均价比标价差——这就是滑点，池子越浅滑点越大。',
          '同一资产在两个场所价格不同时，低买高卖的价差就是套利空间；正是套利者的存在让全网价格保持一致。',
          '链上套利「无风险」是错觉：gas 费、滑点、交易失败照付 gas、被机器人抢先，全是真实成本。',
        ],
        exercises: [
          {
            type: 'choice',
            question: 'Uniswap 类 AMM 如何给资产定价？',
            options: ['订单簿撮合', '恒定乘积公式，由池内两种资产的比例决定', '项目方人工报价', '每天固定一个价格'],
            correct: 1,
            explain: 'x·y=k：有人买走 X，池里 X 变少、Y 变多，X 的价格自动上升——数学公式替代了做市商报价。',
          },
          {
            type: 'tf',
            statement: '在 AMM 中单笔买入的数量越大，平均成交价越差。',
            answer: true,
            explain: '正确。沿着 x·y=k 曲线走得越远价格越陡，这就是滑点——大单在浅池子里的隐形成本极高。',
          },
          {
            type: 'fill',
            before: '恒定乘积做市公式是 x · y =',
            after: '。',
            options: ['k（常数）', '0', 'x + y', '无穷大'],
            correct: 0,
            explain: '两种资产数量的乘积恒定不变，是最经典的 AMM 定价函数。',
          },
          {
            type: 'choice',
            question: '下列哪项不是 DEX 套利利润的真实扣减项？',
            options: ['gas 费', '滑点', '被抢跑导致交易失败的成本', '上市公司分红税'],
            correct: 3,
            explain: '链上套利的三大隐形成本是 gas、滑点和失败交易——毛价差看着诱人，净利润常常所剩无几。',
          },
          {
            type: 'tf',
            statement: '套利者让不同交易场所的价格趋于一致，对整个市场是有益的。',
            answer: true,
            explain: '正确。套利是价格的「清洁工」：赚走价差的同时，也让所有人都能以更一致的价格成交。',
          },
          {
            type: 'match',
            prompt: '把链上概念和解释配对',
      ...
      },
      {
        ...
        diagram: 'fundingArb',
        analogy:
          '像春运的顺风车：回家方向（做多）挤破头，返程方向（做空）没人坐，平台就补贴返程司机。你专门开返程车赚补贴——但补贴随时会调整，平台自己也可能倒闭（FTX 的教训）。',
        tips: [
          '永续合约没有到期日，靠「资金费率」锚定现货：多头拥挤时多头定期付钱给空头，反之亦然。',
          '经典中性套利：买入现货 + 做空等量永续，方向敞口归零，坐收资金费——本质是把「多头的拥挤」变现。',
          '期现套利（Basis Trade）：期货升水时买现货、空期货，到期基差收敛即利润，逻辑与期权平价套利同源。',
          '收益不是白来的：费率会翻脸转负、交易所有对手方风险、极端行情两条腿可能瞬间脱节。',
        ],
        exercises: [
          {
            type: 'choice',
            question: '永续合约靠什么机制贴住现货价格？',
            options: ['交易所人工调价', '资金费率：拥挤的一方定期付钱给另一方', '每天强制交割', '限制涨跌停'],
            correct: 1,
            explain: '资金费率是永续合约的「橡皮筋」：合约价偏离现货越远、多空越失衡，费率把它拉回来的力越强。',
          },
          {
            type: 'fill',
            before: '现货多头 + 等量永续空头的组合，方向敞口约等于',
            after: '。',
            options: ['0', '2 倍做多', '2 倍做空', '无穷大'],
            correct: 0,
            explain: '一条腿涨一条腿跌，价格波动互相抵消，剩下的收益来源就是资金费——这就是 Delta 中性。',
          },
          {
            type: 'choice',
            question: '资金费率为正（多头拥挤）时，钱从谁流向谁？',
            options: ['空头付给多头', '多头付给空头', '交易所付给所有人', '没有人付钱'],
            correct: 1,
            explain: '正费率 = 多头为拥挤买单。牛市狂热期年化资金费一度高达两位数，正是中性套利者的黄金窗口。',
          },
          {
            type: 'tf',
            statement: '资金费率套利没有风险，可以放心上高杠杆。',
            answer: false,
            explain: '错误。费率随时转负、交易所可能倒闭（FTX）、插针行情会打爆杠杆腿——「中性」只中和了方向，没中和其他风险。',
          },
          {
            type: 'choice',
            question: '期现套利（Basis Trade）的利润来自哪里？',
            options: ['预测涨跌', '期货与现货的价差随到期日收敛', '交易所返佣', '资产分红'],
            correct: 1,
            explain: '升水的期货到期必然向现货收敛，锁住价差就锁住利润——和 Put-Call 平价一样，是「关系」而非「方向」的钱。',
          },
          {
            type: 'tf',
            statement: '2022 年 FTX 倒闭说明：再中性的套利策略也承担交易所对手方风险。',
            answer: true,
            explain: '正确。资产放在哪里，就承担哪里的信用风险——策略中性 ≠ 托管无险，这是链上链下通用的第一课。',
          },
        ],
      },
      {
        ...
        title: '稳定币与折价套利',
        analogy:
          '超市里的临期酸奶打 9 折：折扣是对「可能过期」风险的补偿。大多数时候你赚了，但偶尔真过期了（UST 归零），9 折买的也全亏。折价从来不是免费的钱，是风险的价签。',
        tips: [
          '稳定币轻微偏离 $1 时，套利者买入折价、卖出溢价，把价格推回锚定——套利本身就是锚定机制的一部分。',
          '折价资产套利：stETH 等 LST 可能相对 ETH 折价交易，折价 = 市场给流动性与风险标的价，不是白捡的钱。',
          '2022 年 stETH 一度折价约 7%：敢买且等得起提款开放的人赚到了收敛，但当时没人知道要等多久。',
          'UST 的教训：算法稳定币的「套利机制」本身就是死亡螺旋的引擎——锚定靠什么资产支撑，永远是第一问题。',
        ],
        exercises: [
          {
            type: 'choice',
            question: '足额储备的稳定币跌到 $0.995 时，套利者的典型动作是？',
            options: ['恐慌卖出', '买入并等待回锚，赚取价差', '立刻做空', '与己无关'],
            correct: 1,
            explain: '低于 $1 买入、回锚后卖出（或直接按 $1 赎回）——正是这类买盘把价格顶回锚定。',
          },
          {
            type: 'tf',
            statement: '稳定币能稳定在 $1 附近，部分依赖套利者的买卖行为。',
            answer: true,
            explain: '正确。赎回机制给出硬锚，套利者的高频买卖让市场价时刻贴着锚——机制与套利互为表里。',
          },
          {
            type: 'choice',
            question: 'stETH 相对 ETH 折价的本质是什么？',
            options: ['系统故障', '市场对流动性锁定与智能合约风险的定价', '项目方打折促销', '毫无原因的错误定价'],
            correct: 1,
            explain: '折价是风险的价签：当时 stETH 不能即时赎回，折价补偿的正是「等待+合约风险」。看懂价签才能赚价签的钱。',
          },
          {
            type: 'fill',
            before: '2022 年 5 月，算法稳定币',
            after: '脱锚归零，抄底「折价」的人血本无归。',
            options: ['UST', 'USDC', 'DAI', 'BTC'],
            correct: 0,
            explain: 'UST 靠算法而非足额资产锚定，死亡螺旋一旦启动，「折价买入等回锚」变成接飞刀——先问锚定靠什么。',
          },
          {
            type: 'tf',
            statement: '折价越深越应该无脑加仓，因为价格迟早会回锚。',
            answer: false,
            explain: '错误。折价加深往往意味着风险在恶化。回锚的前提是锚还在——UST 的折价「机会」正是这么吞掉抄底者的。',
          },
          {
            type: 'match',
            prompt: '把折价套利概念和本质配对',
    ...
    lessons: [
      {
        ...
        title: 'MEV 与三明治防御',
        analogy:
          '在菜市场大喊「这筐苹果我全要了！」——黄牛听见后抢先一步买光，再加价卖给你。防御不是喊得更小声一点，而是分批悄悄买（拆单+滑点上限），或者干脆走后门交易（私有通道）。',
        tips: [
          'MEV（最大可提取价值）：区块生产者与机器人通过对交易重排、插入获取的利润——你的交易在打包前就躺在公开的 mempool 里被所有人看见。',
          '三明治夹击：机器人看到你的大额买单，抢先买入推高价格，等你高价成交后立刻卖出——你的滑点成了它的三明治馅。',
          '防御三件套：严格设置滑点上限、拆分大单、使用私有交易通道避开公开 mempool。',
          '套利机器人之间拼 gas 竞价、拼节点延迟，竞争以毫秒计——散户手动搬砖基本没有胜算，理解机制是为了不当猎物。',
        ],
        exercises: [
          {
            type: 'choice',
            question: 'MEV 的利润主要来自哪里？',
            options: ['挖矿奖励', '对用户交易的重排、插入与抢先执行', '交易手续费返还', '项目方空投'],
            correct: 1,
            explain: '排序权就是提款机：谁能决定交易顺序，谁就能把「先买后卖」插在你的订单两侧。',
          },
          {
            type: 'tf',
            statement: '公开 mempool 中的交易在被打包之前，任何人都可以看到。',
            answer: true,
            explain: '正确。mempool 是全网公开的候车厅——大额交易一进来，机器人就已经开始计算怎么吃掉你的滑点。',
          },
          {
            type: 'choice',
            question: '三明治夹击中，受害者的损失体现为？',
            options: ['账户被盗', '成交价明显变差，滑点被机器人吃掉', '交易被永久冻结', 'gas 费翻倍'],
            correct: 1,
            explain: '前后两笔夹击把价格短暂推高，你在「山顶」成交——损失就藏在成交价里，很多人被夹了都不知道。',
          },
          {
            type: 'fill',
            before: '防御三明治攻击的第一道防线：把',
            after: '上限设严。',
            options: ['滑点', 'gas', '杠杆', '仓位'],
            correct: 0,
            explain: '滑点上限 = 你能接受的最差成交价。设得严，机器人无利可图，夹击自然放弃。',
          },
          {
            type: 'tf',
            statement: '散户手动在 DEX 之间搬砖，速度上可以稳定跑赢专业机器人。',
            answer: false,
            explain: '错误。这是毫秒与 gas 竞价的军备竞赛。散户的正确姿势是理解机制、保护自己，而不是参赛。',
          },
          {
            type: 'match',
            prompt: '把 MEV 概念和比喻配对',
            pairs: [
              ['mempool', '公开的候车厅'],
              ['front-run', '抢在你前面买入'],
              ['私有通道', '绕开公开广播的后门'],
      ...
      },
      {
        ...
        title: '闪电贷与原子套利',
        analogy:
          '魔法借款：借你一个亿，但必须在「同一个瞬间」用完并还清，还不上就当这一切从未发生。听起来荒诞，但链上的「同一瞬间」（一笔交易之内）真实存在——这是传统金融里不存在的物种。',
        tips: [
          '闪电贷：在同一笔交易内完成借款、使用、归还，无需任何抵押——因为还不上时整笔交易自动回滚，风险为零。',
          '原子性是链上套利的超能力：多步操作要么全部成功、要么全部失败，彻底消除「一条腿成交另一条腿失败」的腿部风险。',
          '清算套利：借贷协议里抵押不足的仓位人人可清算，清算人获得折价奖励——它是协议安全的免疫系统。',
          '闪电贷也被用于攻击（如操纵预言机报价）：工具中性，理解机制既是学套利，也是学安全。',
        ],
        exercises: [
          {
            type: 'choice',
            ...
            options: [
              '放贷方慈善',
              '借款与归还必须发生在同一笔交易内，还不上整笔回滚',
              '有保险公司兜底',
              '金额太小无所谓',
            ],
            correct: 1,
            explain: '原子性保证了「要么借了又还了，要么什么都没发生」——违约在数学上不可能，抵押也就多余了。',
          },
          {
            type: 'tf',
            statement: '原子性消除了多步套利中「一条腿成交、另一条腿失败」的风险。',
            answer: true,
            explain: '正确。传统跨市场套利最怕单腿裸奔；链上把整串操作打包成一个原子事务，全成或全败。',
          },
          {
            type: 'choice',
            question: '清算人在借贷协议中扮演什么角色？',
            options: ['破坏者', '清除坏账并获得折价奖励，维护协议偿付能力', '免费志愿者', '监管机构'],
            correct: 1,
            explain: '抵押不足的仓位不及时清算会变成全协议的坏账。清算奖励让「维护安全」变成一门有利可图的生意。',
          },
          {
            type: 'fill',
            before: '闪电贷若未在同一笔交易内归还，整笔交易会',
            after: '。',
            options: ['回滚，如同从未发生', '分期偿还', '自动展期', '转成抵押贷款'],
            correct: 0,
            explain: '回滚（revert）是以太坊的原生能力：状态回到交易之前，只损失一点 gas。',
          },
          {
            type: 'tf',
            statement: '闪电贷只能用于善意套利，无法被用于攻击。',
            answer: false,
            explain: '错误。多起协议被黑事件正是用闪电贷放大资金去操纵价格预言机——理解机制也是理解风险。',
          },
          {
            type: 'choice',
            question: '传统金融里为什么不存在闪电贷？',
            options: [
              '监管禁止',
              '缺少原子性：两步操作之间总存在违约的时间窗口',
              '银行家没想到',
              '利率太高',
            ],
            correct: 1,
            explain: '传统结算以天计，任何两步之间都可能违约；链上一笔交易内的「同时性」才让零抵押借贷成为可能。',
          },
        ],
      },
      {
        ...
        title: '链上风险清单',
        analogy:
          '链上世界像没有交警的高速公路：跑得快（原子结算、无许可）但没有护栏——车坏了（合约漏洞）没有 4S 店，钥匙丢了（私钥）没有补办窗口。上路前的检查清单，比车速重要一百倍。',
        tips: [
          '智能合约风险永远排第一：一个漏洞可以让本金瞬间归零，审计只能降低概率、不能消除。',
          '「无常损失」提醒：给 AMM 提供流动性不是套利——两种资产比价变动时，LP 会跑输单纯持有，这是做市的成本。',
          '托管与桥风险：跨链桥是历史上被黑损失最大的重灾区；资产放交易所则承担对手方风险。',
          '链上收益的第一性检查：这份收益从哪来、谁在付钱给你？说不清来源的高收益，你自己就是收益来源。',
        ],
        exercises: [
          {
            type: 'choice',
            question: '链上策略的头号风险是？',
            options: ['网速太慢', '智能合约漏洞导致本金归零', '界面不好看', 'gas 波动'],
            correct: 1,
            explain: '价格风险再大也有边界，合约漏洞是 0 或 1 的生死题。协议审计历史、运行时长、TVL 都是检查项。',
          },
          {
            type: 'tf',
            statement: '给 AMM 池提供流动性是一种无风险套利。',
            answer: false,
            explain: '错误。LP 是做市不是套利：比价一变就有无常损失，手续费收入未必补得回来。',
          },
          {
            type: 'choice',
            question: '无常损失在什么情况下发生？',
            options: ['池内两种资产的比价发生变化', '手续费太低', 'gas 太高', '行情横盘不动'],
            correct: 0,
            explain: '比价变动越大，LP 相对「拿住不动」的差距越大——横盘时 LP 最舒服，单边行情最受伤。',
          },
          {
            type: 'fill',
            before: '跨链',
          ...
          },
          {
            ...
            correct: 1,
            explain: '资金费、价差、清算奖励都说得清来源；说不清的高收益历史上大多是庞氏结构——UST 20% 年化殷鉴不远。',
          },
          {
            type: 'match',
            prompt: '把链上风险和描述配对',
