...
export const blogPosts: BlogPost[] = [
  {
    id: '11',
    title: 'AI 最不该替你做的，是算出一个看似更精确的答案',
    slug: 'ai-should-not-replace-judgment-with-calculation',
    excerpt: '当数据、回测和模型变得越来越便宜，真正稀缺的不是更快地算，而是知道该定义什么问题、相信什么证据，以及在哪些地方拒绝行动。',
    content: `最近看了一篇前 Citadel 高管谈 AI 与金融的文章。里面有一句话很容易被记住：AI 最不该干的活，就是算数。
...
本文受「前 Citadel 高管：AI 最不该干的活，就是算数」一文启发，结合我对 AI、研究流程与链上执行的延展思考。不构成投资建议。`,
    ...
    category: 'thinking',
    tags: ['AI', 'investing', 'research', 'judgment', 'market structure'],
  ...
  {
    id: '10',
    title: '降息之后，为什么 30 年美债收益率还能走高？',
    slug: 'why-long-bond-yields-rise-after-rate-cuts',
    excerpt: 'Fed 可以决定钱今天有多贵；但市场决定把钱借给美国三十年，需要多少补偿。理解短端与长端的分工，才不会把“降息”误读为所有利率都会下降。',
    content: `经常被问到一个看似矛盾的问题：美联储已经降息，为什么 30 年期美债收益率反而能走高？
...
今天借出 100 美元，未来拿回的是固定本金和利息；但如果购买力持续被通胀侵蚀，实际回报便不够。于是投资人会要求更高收益率作为补偿，这就是**通胀风险溢价**。
...
于是可以出现这样的组合：短端因降息而下行，长端却因通胀和财政担忧而上行。这通常被称为**熊市陡峭化（bear steepening）**。
...
灵感来源：[@theinvestorlei 的 Instagram 帖子](https://www.instagram.com/p/DcZyeU2D343/?img_index=1)。本文为 Nicole 的整理与延展，不构成投资建议。`,
    coverImage: 'https://images.unsplash.com/photo-1611974717482-7b1b8f1f40d4?w=1200&auto=format&fit=crop&q=80',
    category: 'thinking',
    tags: ['macro', 'bonds', 'interest rates', 'investing'],
