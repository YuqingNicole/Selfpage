...
export const sfx = {
  ...
  /** 暴击：高频金属双击 */
  crit() {
    tone(1175, 0, 0.07, 'square', 0.09);
    tone(1760, 0.06, 0.12, 'square', 0.1);
    tone(2349, 0.12, 0.2, 'sine', 0.09);
  },
  /** 升级：上行号角 + 长尾音 */
  levelup() {
    [659, 784, 988, 1319, 1568].forEach((f, i) => tone(f, i * 0.08, 0.2, 'triangle', 0.13));
    tone(1976, 0.45, 0.5, 'sine', 0.1);
  },
};
